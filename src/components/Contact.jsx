...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const SERVICE_ID = process.env.REACT_APP_EMAILJS_SERVICE_ID || 'service_lhu8zek';
    const TEMPLATE_ID = process.env.REACT_APP_EMAILJS_TEMPLATE_ID || 'template_u9br3ja';
    const PUBLIC_KEY = process.env.REACT_APP_EMAILJS_PUBLIC_KEY || '44zxmJdbEeHX_4uMS';
