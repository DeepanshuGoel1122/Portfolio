  ...
  return (
    <footer className="site-footer">
      <div className="container footer-inner">
        <p className="muted" style={{ fontSize: 14 }}>© 2024 Deepanshu Goel. All rights reserved.</p>
        <div style={{ display: 'flex', gap: 24 }}>
          <a className="icon-link" aria-label="GitHub profile link" href="https://github.com/DeepanshuGoel1122">
          ...
          <a className="icon-link" aria-label="LinkedIn profile link" href="https://www.linkedin.com/in/deepanshugoel1122/">
            <svg aria-hidden="true" className="h-6 w-6" fill="currentColor" viewBox="0 0 24 24">
